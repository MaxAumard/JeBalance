...
public class DenonciationSQL : Denonciation
{
    ...
    [Column("fk_Informant")]
    public new string InformantId { get; set; } = string.Empty;
    [Column("fk_Suspect")]
    public new string SuspectId { get; set; } = string.Empty;
    [Column("Date")]
    ...
    public  virtual PersonSQL? Informant { get; set; }
    [ForeignKey(nameof(SuspectId))]
    public  virtual PersonSQL? Suspect { get; set; }
